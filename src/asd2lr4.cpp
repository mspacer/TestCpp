...
bool testBinarySearchTree() {
    ...
    for (int i = 0; i < itersToRangeQueries; i++) {
        StudentAsd4 minData = StudentAsd4();
        StudentAsd4 maxData = StudentAsd4();
